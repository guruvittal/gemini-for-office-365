...
MANIFEST_PATH="$REPO_ROOT/manifest-ca.xml"
...
echo "🚀 Installing Gemini Enterprise Office 365 Add-in (manifest-ca.xml) on macOS..."
...
echo "   3. Click 'Gemini Assistant' in the ribbon."
