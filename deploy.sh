...
ALLOW_SERVICE_ACCOUNT_FALLBACK=${ALLOW_SERVICE_ACCOUNT_FALLBACK}" \
  ...
  AUTH_ENV_VARS="GE_GCP_PROJECT_ID=${GE_GCP_PROJECT_ID},GE_GCP_LOCATION=${GE_GCP_LOCATION},DOWNSTREAM_BACKEND_URL=${BACKEND_URL},USER_AUTH_MODE=${TRACK},VERBOSE_LOGGING=true,REQUIRE_ENTRA_AUTH=${REQUIRE_ENTRA_AUTH:-false}"
